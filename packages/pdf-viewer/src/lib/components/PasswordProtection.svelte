...
<div class="space-y-4">
  ...
  {#if isProtected}
    <div
      class="p-3 rounded-lg border border-[var(--ui-warning)]/30 bg-[var(--ui-warning)]/5"
    >
    ...
    {#if showForm}
      ...
      >
        ...
        <Input
          ...
          type="password"
          placeholder="Owner password (to change permissions)"
        />
        <Input
        ...
        {#if error}
          <div
            class="flex items-center gap-2 text-sm text-[var(--ui-destructive)]"
          >
