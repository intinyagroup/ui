  ...
  >
    ...
    {:else}
      ...
      >
        ...
        {:else}
          <Upload
            class="size-8 mx-auto mb-2 text-[var(--ui-muted-foreground)]"
          />
          <span class="text-sm text-[var(--ui-muted-foreground)]"
            >Drop image or click to browse</span
          >
        {/if}
      </div>
      <input
            ...
            <button
              ...
              class={cn(
                ...
                imageAlign === "center"
                  ? "border-[var(--ui-primary)] bg-[var(--ui-primary)]/5"
                  : "border-[var(--ui-border)]",
              )}><AlignCenter class="size-4" /></button
            >
            <button
              ...
              class={cn(
                ...
                imageAlign === "right"
                  ? "border-[var(--ui-primary)] bg-[var(--ui-primary)]/5"
                  : "border-[var(--ui-border)]",
              )}><AlignRight class="size-4" /></button
            >
            <button
              onclick={() => (imageAlign = "full")}
              class={cn(
                "p-2 rounded border",
                imageAlign === "full"
                  ? "border-[var(--ui-primary)] bg-[var(--ui-primary)]/5"
