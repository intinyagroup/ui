...
const meta = {
  ...
  args: {
    ...
    description:
      "Enterprise data table with server-side support, sorting, and export",
    searchable: true,
    exportable: true,
    selectable: true,
    densityToggle: true,
...
export const MobileCardViewResponsive: Story = {
  args: {
    ...
    expandable: true,
    description:
      "Resize viewport to mobile (< 640px) to see automatic transformation into stacked card layout without horizontal overflow",
  },
};
