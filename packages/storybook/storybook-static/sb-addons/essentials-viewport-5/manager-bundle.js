try {
  (() => {
    ...
    var $ = Se(ce()),
      ...
      Ce = { [T]: { value: void 0, isRotated: !1 } },
      _e = { viewport: "reset", viewportRotated: !1 },
      Ae = globalThis.FEATURES?.viewportStoryGlobals ? Ce : _e,
      pe = (e, t) => e.indexOf(t),
      Re = (e, t) => {
        let a = pe(e, t);
      ...
      Ee = v.div({ display: "inline-flex", alignItems: "center" }),
      se = v.div(({ theme: e }) => ({
      ...
      Te = v(P)(() => ({ display: "inline-flex", alignItems: "center" })),
      xe = v.div(({ theme: e }) => ({
        fontSize: e.typography.size.s2 - 1,
        marginLeft: 10,
      })),
      ...
      Pe = ({ api: e }) => {
        ...
        let w = d ? r.styles.height : r.styles.width,
      ...
      Ne = v(P)(() => ({ display: "inline-flex", alignItems: "center" })),
      ze = v.div(({ theme: e }) => ({
        fontSize: e.typography.size.s2 - 1,
        marginLeft: 10,
      })),
            ...
            : c.createElement(
                ...
                c.createElement(
                  q,
                  {
                    placement: "top",
                    tooltip: ({ onHide: u }) =>
                      c.createElement(j, { links: Ve(p, n, t, u) }),
                    closeOnOutsideClick: !0,
                    onVisibleChange: m,
                  },
                  c.createElement(
    ...
    H.register(L, (e) => {
      H.add(L, {
        ...
        render: () =>
          FEATURES?.viewportStoryGlobals ? N(Pe, { api: e }) : N(Ge, null),
      });
    });
  })();
} catch (e) {
