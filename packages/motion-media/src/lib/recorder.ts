...
export type RecordingState =
  "idle" | "preparing" | "recording" | "paused" | "stopping";
...
export async function startScreenRecording(options: RecordingOptions = {}) {
...
export async function startAudioRecording(options: RecordingOptions = {}) {
