<script lang="ts">
  ...
  import { Badge } from "@intinyagroup/ui/components/badge";
  ...
  import {
    ...
    CardContent,
    CardFooter,
  } from "@intinyagroup/ui/components/card";
  import {
    Alert,
    AlertTitle,
    AlertDescription,
  } from "@intinyagroup/ui/components/alert";
  import { Switch } from "@intinyagroup/ui/components/switch";
  import {
    Select,
    SelectTrigger,
    SelectValue,
  ...
  import {
    ...
    SliderRange,
    SliderThumb,
  } from "@intinyagroup/ui/components/slider";
...
<svelte:head>
  <title>Playground — Intinya UI</title>
  <meta
    name="description"
    content="Live interactive component playgrounds for Intinya UI"
  />
</svelte:head>
...
<section class="mx-auto max-w-5xl px-4 py-12">
  <div class="mb-10">
    ...
    <p class="mt-2 text-[var(--ui-muted-foreground)]">
      Tweak props live. Switch to the <strong
        class="font-medium text-[var(--ui-foreground)]">Code</strong
      > tab to copy the generated snippet.
    </p>
  </div>
    ...
    >
      {#snippet render(v)}
        <div class="w-64">
          ...
          >
            <SliderRange
              class="absolute h-full rounded-full bg-[var(--ui-primary)]"
            />
            <SliderThumb
              index={0}
              class="block size-4 rounded-full bg-[var(--ui-primary)] shadow transition-colors focus-visible:outline-2 focus-visible:outline-[var(--ui-ring)]"
            />
          </SliderRoot>
        </div>
      {/snippet}
