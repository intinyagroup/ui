...
```svelte
<script>
  import { OctagonCard } from "@intinyagroup/flat";
</script>
...
<OctagonCard title="Customers" description="Loved by 10k teams" color="teal">
...
```bash
npx @intinyagroup/cli add flat-octagon-card
```
