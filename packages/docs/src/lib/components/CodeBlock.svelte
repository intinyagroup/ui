...
<div
  class="my-4 overflow-hidden rounded-lg border border-[var(--ui-border)] bg-[oklch(0.16_0.01_260)]"
>
  <div
  ...
  <pre
    class="overflow-x-auto p-4 font-mono text-[13px] leading-relaxed text-white/90"><code
      >{display}</code
    ></pre>
</div>
