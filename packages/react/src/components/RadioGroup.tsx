...
>(({ className, ...props }, ref) => (
  <ArkRadioGroup.Item
    ref={ref}
    className={cn(
      "flex items-center gap-2 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50",
      className,
    )}
    {...props}
  />
...
export const RadioGroupItemControl = React.forwardRef<
  HTMLDivElement,
...
export const RadioGroupItemText = React.forwardRef<
  HTMLSpanElement,
...
>(({ className, ...props }, ref) => (
  <ArkRadioGroup.ItemText
    ref={ref}
    className={cn(
      "text-sm font-medium leading-none select-none text-[var(--ui-foreground)]",
      className,
    )}
    {...props}
  />
