...
export const buttonVariants = tv({
  ...
  variants: {
    variant: {
      default:
        "bg-[var(--ui-primary)] text-[var(--ui-primary-foreground)] shadow hover:bg-[var(--ui-primary)]/90",
      destructive:
        "bg-[var(--ui-destructive)] text-[var(--ui-destructive-foreground)] shadow-sm hover:bg-[var(--ui-destructive)]/90",
      outline:
        "border border-[var(--ui-input)] bg-[var(--ui-background)] shadow-sm hover:bg-[var(--ui-accent)] hover:text-[var(--ui-accent-foreground)]",
      secondary:
        "bg-[var(--ui-secondary)] text-[var(--ui-secondary-foreground)] shadow-sm hover:bg-[var(--ui-secondary)]/80",
      ghost:
