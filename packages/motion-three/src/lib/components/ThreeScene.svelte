      ...
      switch (lightDef.type) {
        case "ambient":
          light = new THREE.AmbientLight(
            new THREE.Color(lightDef.color),
            lightDef.intensity,
          );
          break;
        case "directional":
      ...
      switch (objDef.geometry.type) {
        case "box":
          geometry = new THREE.BoxGeometry(
            objDef.geometry.params?.width ?? 1,
            objDef.geometry.params?.height ?? 1,
            objDef.geometry.params?.depth ?? 1,
          );
          break;
        case "sphere":
          geometry = new THREE.SphereGeometry(
            objDef.geometry.params?.radius ?? 1,
            32,
            16,
          );
          break;
        case "cylinder":
          geometry = new THREE.CylinderGeometry(
            objDef.geometry.params?.radiusTop ?? 1,
            objDef.geometry.params?.radiusBottom ?? 1,
            objDef.geometry.params?.height ?? 1,
          );
          break;
        case "cone":
        ...
        case "torus":
          geometry = new THREE.TorusGeometry(
            objDef.geometry.params?.radius ?? 1,
            objDef.geometry.params?.tube ?? 0.3,
            16,
            100,
          );
          break;
